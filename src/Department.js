...
export class Department extends Component{
    ...
    changeDepartmentIDFilter = (s)=>{
        this.state.DepartmentIDFilter=s.target.value;
        this.FilterFn();
    }
    changeDepartmentNameFilter = (s)=>{
        this.state.DepartmentNameFilter=s.target.value;
        this.FilterFn();
    }
    ...
    changeDepartmentName =(s)=>{
        this.setState({DepartmentName:s.target.value});
    }
